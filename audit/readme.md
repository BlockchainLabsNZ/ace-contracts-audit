...
As described in our obervations the owner of the contract maintains significant control over the smart contract, but they are expecting to mitigate this risk through the use of a multisig contract to deploy the contract.
